  ...
  &.holo1:before {
    ...
    background-image: url(https://res.cloudinary.com/simey/image/upload/Dev/PokemonCards/illusion.webp),
      repeating-linear-gradient(
        ...
        rgba(120, 148, 255, 1) calc(var(--boxBeforeSparkX, 5%) * 5),
        rgb(216, 117, 255) calc(var(--boxBeforeSparkX, 5%) * 6),
        rgb(255, 119, 115) calc(var(--boxBeforeSparkX, 5%) * 7)
      ),
      repeating-linear-gradient(
        133deg,
        #0e152e 0%,
